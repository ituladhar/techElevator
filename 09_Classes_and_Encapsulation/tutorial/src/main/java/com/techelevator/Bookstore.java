...
public class Bookstore {
    ...
    public static void main(String[] args) {
        ...
        twoCities.setTitle("A tales of Two Cities");
...
//        System.out.println("Title: " + twoCities.getTitle()+ ", Author: "+ twoCities.getAuthor()+", Price: $"+twoCities.getPrice());
        ...
        Book threeMusketeers = new Book("The Three Musketeers", "Alexandre Dumas", 12.99 );
        Book childhoodEnd = new Book("Childhood's End", "Aurthur C. Clark", 4.55);
