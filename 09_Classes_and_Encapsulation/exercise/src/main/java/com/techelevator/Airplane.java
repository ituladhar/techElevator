...
public class Airplane {
    ...
    public boolean reserveSeats (boolean forFirstClass, int totalNumberOfSeats){
        if(forFirstClass ){
            if (totalNumberOfSeats > this.getAvailableFirstClassSeats()) return false;
               else {bookedFirstClassSeats +=totalNumberOfSeats; return  true;}
        }


         else {   if (totalNumberOfSeats > this.getAvailableCoachSeats()) return false;
             else {bookedCoachSeats += totalNumberOfSeats; return true;}
        }
