...
public class Exercises {
	...
	public int[] rotateLeft3(int[] nums) {
		int [] newArrayRotatedLeft = {nums[1], nums[2], nums[0]};
			return newArrayRotatedLeft;
	}
	...
	public int[] reverse3(int[] nums) {
		/*int [] arrayRevers3 = new int [3];
		 for(int i = 2; i >= 0 ; i--) // revers array
		   {
		   for(int j = 0; j < 3; j++)
			arrayRevers3[j] = nums[i];
			}
		return arrayRevers3;*/

       int [] arrayRevers3 = {nums[2], nums[1], nums[0]};
			   return arrayRevers3;
	...
	public int[] middleWay(int[] a, int[] b) {
		int [] middleWay= {a[a.length/2], b[b.length/2]};
		return middleWay;
	}
